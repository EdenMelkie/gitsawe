// bahirehasab_screen.dart
import 'package:flutter/material.dart';
import 'bahirehasab.dart';

class BahireHasabScreen extends StatefulWidget {
  final int? initialYear;
  final int? initialMonth;
  final int? initialDay;

  const BahireHasabScreen({
    this.initialYear,
    this.initialMonth,
    this.initialDay,
    super.key,
...
class _BahireHasabScreenState extends State<BahireHasabScreen> {
  ...
  void initState() {
    ...
    // Pre-fill inputs if initial values are provided
    if (widget.initialYear != null) {
      _yearController.text = widget.initialYear.toString();
    }
    if (widget.initialMonth != null) {
      _monthController.text = widget.initialMonth.toString();
    }
    if (widget.initialDay != null) {
      _dayController.text = widget.initialDay.toString();
    }

    // Auto-calculate if all values are provided
    if (widget.initialYear != null &&
